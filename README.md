<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="SimpliGen Community Preset Packs: 138 ready-to-run presets in 44 packs. One zip, one click, models auto-downloaded into SimpliGen.">
</p>
...
<p align="center">
  <img src="./assets/readme/section-catalog.svg" width="100%" alt="01 — Pack catalog: 44 packs, 138 presets.">
</p>
...
| MiniMax H3 (LMS Sharpen) | 1 | MiniMax H3 Reference (pruned INT8) + LMS LoRA | **Video in, video out, same size.** Alissonerdx's LMS sharpening LoRA used as trained: the whole clip goes in as an aligned latent guide (native Add Guide, frame 0) and is re-rendered with PDD 8-step at full denoise. Measured on the same clip and seed: crop sharpness 712 (guide only) -> 789 with the LoRA, source 683; composition, motion and audio untouched; 253 s per 5 s at 480p. For a higher tier run Video Refine first |
