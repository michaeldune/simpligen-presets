...
| Viggle Animate (Character Swap) | 1 | Viggle-Animate (MiniMax H3 ref2va finetune, pruned INT8) + Flux 2 Klein 9B | **Video in, your character out.** Driving clip in Reference Video 1, one picture of your character: Klein repaints the clip's first frame with your character in the same pose and light, then Viggle-Animate carries it through the clip's motion and camera in three passes, keeping the background and the clip's own soundtrack. 5.2 s at 0.4 MP in the clip's aspect, about 3 minutes on 12 GB. Use the prompt box to name anything the original person holds or wears that should go. Works best when the performer is large in frame with an outline like your character's. 45.6 GB download. **Licences: MiniMax H3 Community License + FLUX Non-Commercial, non-commercial use only; use consented references and label output as AI-generated** |
