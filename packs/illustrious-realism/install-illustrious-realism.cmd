...
copy /Y "%~dp0illustrious-realism-pack.json" "%PRESETS%\illustrious-realism-pack.json" >nul
...
echo. & echo Community — Illustrious Realism restored. Restart SimpliGen. & echo. & pause
