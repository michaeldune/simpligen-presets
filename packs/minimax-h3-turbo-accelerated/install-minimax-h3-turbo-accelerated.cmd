...
echo. & echo Done. Restart SimpliGen. & echo. & echo IMPORTANT: Two custom nodes must be installed first: & echo - ComfyUI-Spectrum-MiniMax-H3 (Spectrum) & echo - ComfyUI-SolAttn_triton (Sol-Attn) & echo. & echo SageAttention is no longer one of them - SimpliGen applies it via & echo Settings ^> Advanced ^> faster attention. Without it these presets & echo still run, just slower. & echo. & pause
exit /b 0
:error
